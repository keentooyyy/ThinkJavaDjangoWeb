...
from StudentManagementSystem.views.teacher.ranking_students import student_ranking_teacher
...
urlpatterns = [  # path('login/', teacher_login, name='teacher_login'),
    ...
    path("teacher/student-ranking/", student_ranking_teacher, name="teacher_student_ranking"),
